 ...
 * @author Llop
 */
public interface BetRepository extends ExtendedMongoRepository<Bet, String> {

	List<Bet> findByPlayer(final String player);
	List<Bet> findByPlayerAndTypeAndStatus(final String player, final String type, final String status);
